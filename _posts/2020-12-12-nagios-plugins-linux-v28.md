...
summary: A version of Nagios Plugins for Linux is out! New features include the new plugin check_pressure and the porting to Linux Alpine 3.12 with packaging available.
---
