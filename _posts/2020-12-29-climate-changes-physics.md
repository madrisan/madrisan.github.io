...
Tutti i corpi ad una temperatura $$T$$ superiore allo zero assoluto (zero gradi sulla scala Kelvin,
equivalente alla temperature di &minus;273,15°C) possiedono una *energia interna* che si manifesta
a livello microscopico come movimento o oscillazione degli atomi che lo costituiscono.

La *temperatura* di un corpo à la misura di questa energia interna. Quando quest'ultima aumenta,
cioè il movimento interno dei suoi atomi aumenta, la temperatura del corpo cresce.
...
<p>
I fisici utilizzano di preferenza la scala Kelvin poichè la temperatura espressa in questo modo è
proporzionale all'energia interna di un corpo. Ad esempio un raddoppio della temperatura in gradi
Kelvin di un corpo si traduce in un raddoppio della sua energia interna.
Questa proprierà non è invece valida per una misura in gradi centrigradi.
Si passa facilmente da una temperatura espressa in gradi Kelvin all'equivalente temperatura
in gradi centigradi sottraendo 273 gradi (più precisamente 273,15 gradi).
</p>
</div>

Questa energia si diffonde nello spazio anche in assenza di materia come
...
I nostri occhi, frutto dell'evoluzione biologica, sono sensibili ad una parte dei fotoni emessi
dal sole e le cui frequenze definiamo per questo *visibili*.
...
Per la *prima legge della termodinamica* sappiamo che in un sistema chiuso *l'energia si conserva*.
Cioè se un corpo perde energia emettendo fotoni, questi ultimi quando colpiranno altri oggetti
e ne verranno da questi assorbiti, ne aumenteranno l'energia interna della stessa quantità di
energia.
...
Essendo questi oggetti a temperatura ambiente (mediamente circa 300°K), i loro fotoni hanno,
come risulta dalla legge di Stephan-Boltzmann, una energia inferiore di quelli di origine solare,
che ha una temperatura superficiale stimata a circa 6000°K.
La loro lunghezza d'onda si trova quindi *nella zona degli infrarossi* invece che nel campo
visibile e delle frequenze superiori.
...
I corpi, emettendo ed ricevendo fotoni, cambiano in genere la loro temperatura.
Esiste un caso particolare.
Se un corpo assorbe ed emette la stessa quantità di energia, la sua temperatura non cambia.
Si dice allora che è in una situazione di *equilibrio termodinamico*.

#### Gas ad effetto serra

Il sole costituisce la nostra sorgente naturale di energia, distribuita secondo lo spettro
solare. Essa viene emessa dalla nostra stella in ogni direzione e a seconda della stagione
...
fabbisogno energetico dell'umanità intera, attualmente di circa 15 TW.

Parte della luce solare viene riflessa dall'atmosfera e dalla terra verso lo spazio.
...
fredde polari. La sua concentrazione è comunque regolata dal *ciclo dell'acqua*:
...
pressochè <i>indefinitamente</i> (per centinaia di migliaia di anni), spostandosi essenzialmente
tra atmosfera, oceani e vegetazione.
L'interessante ciclo del carbonio terrestre è descritto in modo dettagliato nel libro
"<i>The Long Thaw</i>" di David Archer e sarà descritto in un prossimo post.
</p>
</div>
...
Questi gas infatti assorbono parte dei fotoni infrarossi emessi dalla superficie terrestre.
...
Il flusso di energia IR aumenta con il crescere della temperatura, verso un nuovo equilibrio
termico terrestre, che tuttavia non può essere raggiunto perchè ogni anno vengono rilasciati
nell'atmosfera dalle attività umane miliardi di tonnellate di $$CO_2$$, bruciando combustibili
fossili e distruggendo foreste che ne assorbirebbero una parte considerevole
(transformandola per mezzo della fotosintesi in ossigeno ed altre sostanze organiche).

I risultati scientifici, cumulati soprattutto negli ultimi trenta anni, ci mostrano che il
...
insensato ed il cui prezzo maggiore sarà pagato da altri: dalle generazioni future.
